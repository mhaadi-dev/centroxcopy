...
export const nestedServicePage = defineType({
    name: "nestedservicesPages",
    title: "Nested Services Pages",
    type: "document",
    ...
    fields: [
      ...
      defineField({
        ...
        title: "Custom Slug",
        type: "slug",
        description: "A manually generated slug for additional routing.",
        options: {
          source: (doc) => `${doc.name}-custom`,
        },
      }),
      defineField({
        name: "heroSection",
