  ...
  fields: [
    ...
    defineField({
      ...
      validation: (Rule) =>
        Rule.required()
          .max(60)
          .warning("Meta title should not exceed 60 characters.")
    }),
    defineField({
    ...
    }),
    {
      ...
      title: "Category",
      description:
        "This will be a main slug `/blogs/category/label`. Enter Category.",
      type: "reference",
      to: [{ type: "category" }],
    ...
    {
      name: "keywords",
      title: "Keywords for Schema Markup",
      type: "string",
      description:"Enter comma separated keywords for this blog.",
      validation: (Rule) => Rule.required().error("Keywords are required.")
    }
  ],
...
export const AuthorSchema = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: "text",
      validation: (Rule) =>
        Rule.max(250).error("Bio should not exceed 250 characters.")
    }),
    defineField({
      name: "image",
      title: "Author Image",
...
export const CategorySchema = defineType({
  ...
  fields: [
    defineField({
      ...
      type: "string",
      description:
        'Category name must be lowercase and hyphen-separated (e.g., "example-category")',
    ...
    defineField({
      ...
      type: "string",
      validation: (Rule) =>
        Rule.required().error("Category Meta Title is required.")
    }),
    defineField({
      ...
      type: "string",
      validation: (Rule) =>
        Rule.required().error("Category Meta Description is required.")
    })
  ]
});
