    ...
    <div>
      <LandingLayout>
        <main className="max-w-[2500px] mx-auto bg-[#060606] ">
          <HeroSection  heading="Engineering Custom LLMs from Ideation to Implementation"/>
          <LogosCarousel/>
          ...
          <PointsandImagesSection arrayData={arrayData} heading={"What You Gain"} description={"Partnering with Centrox AI for custom LLM development empowers your team to:"} />
