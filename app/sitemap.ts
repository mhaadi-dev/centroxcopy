...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const staticLinks = [
    ...
    { url: 'https://centrox.ai/blogs/', lastModified: new Date().toISOString(), priority: 0.80 },
    { url: 'https://centrox.ai/blogs/search', lastModified: new Date().toISOString(), priority: 0.80 },
  ];
