...
export const sectionheadings = "w-full lg:w-3/4 mx-auto text-2xl lg:text-5xl text-white text-center font-bold "
export const sectionsubheadings = "text-xl text-white text-center w-full lg:w-3/4 mx-auto "
