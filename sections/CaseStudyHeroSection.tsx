...
export const CaseStudyHeroSection = ({isGradientText=true,divider=false,tags=false,...props}: PropsI) => {
  return (
    <div className={classNames(" w-full  pb-10 relative ")}>
      <section
        className={classNames(
          "flex pt-28 lg:pt-32  w-[100%] 2xl:w-5/5  lg:pl-0   flex-col lg:flex-row gap-y-6 lg:gap-0 justify-between items-center",
        ...
        <div className="flex bg-red-400">
          ...
          {props?.bgimage2 && (
            <Image
              src={props?.bgimage2}
              className={classNames(
                "h-full object-contain  absolute left-0 top-4",
...
<section className="sm:w-auto px-4 sm:px-0 mx-auto flex flex-col lg:flex-row items-center   justify-between sm:mx-[2.5rem] md:mx-[3rem] lg:mx-[3.5rem] xl:mx-[4.5rem] 2xl:mx-[15rem] mt-8 lg:mt-12 2xl:mt-24">
