          ...
          <div className="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-72">
            <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-300">
                ...
                experiences. Whether it's designing easy websites, using smart
                AI tricks, or making smooth mobile apps, Centrox AI is here to
                make cool tech that helps our clients. We love coming up with
                new ideas and doing our best to make super-smart tech solutions
                for everyone.
              </p>
        ...
        {msg && (
          <AlertOverlay
            ...
            headingCustomClass={classNames(
              error?.length > 0
                ? "!text-red-400"
                : "!text-white  !border-none !font-medium"
            )}
          />
        )}
      </div>
