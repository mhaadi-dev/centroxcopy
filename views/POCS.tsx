  ...
  return (
    <div
      ...
      className={classNames(
        "rounded-lg text-white font-bold text-xl md:text-lg 2xl:text-3xl p-4 2xl:p-10 cursor-pointer flex justify-between items-center"
        // showHoverState &&
      ...
      <div className=" w-4/5 grid grid-cols-1 lg:flex justify-between mt-14 gap-10 sm:gap-0">
        ...
        <div className="flex flex-col justify-between  lg:w-[30%]">
          <div className="flex flex-col gap-4 bg-gray-dark  h-1/2 p-4 rounded-xl text-white mt-10 lg:mt-5">
            <div className="text-sm md:text-lg lg:text-2xl 2xl:text-4xl font-semibold">
              {lastHoveredCard === 4
            ...
            <div className="mg:text-lg 2xl:text-xl font-medium">
              {lastHoveredCard === 4
