  ...
  return (
    <>
      <div
        ...
        className={classNames("w-[85%] mx-auto  mt-24  lg:mt-60 overflow-hidden  rounded-xl ",widthClassName)}
      >
        <section
          className={classNames("w-full  mx-auto flex flex-col gap-8 rounded-xl relative py-4 px-2 lg:p-12 ", )}
          style={{
            ...
            {width && width > 900 && (
              <>
                <div className={classNames("grid grid-cols-4",colsClassName)} >
                    ...
                    return (
                      <div
                        ...
                        className={classNames(
                          "text-white text-sm lg:text-md 2xl:text-xl font-semibold text-center p-3 rounded-t-xl cursor-pointer whitespace-nowrap", tabsClassName
                 ...
                 style={{
                  marginLeft: hoverIndex >0 ?  `${hoverIndex * 100}%` : "", // Removed extra spaces inside the template literal
                }}
                 />
                </div>
