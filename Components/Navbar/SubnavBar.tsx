...
const SubnavBar = ({searchView}:Props) => {
  ...
  return ( <><nav className=" hidden xl:flex  justify-center fixed z-40 top-24 left-0 py-4 sm:h-16 items-center w-full bg-gray-900 ">
    <div className="flex items-center justify-between w-[90%] mx-[1.5rem] 2xl:mx-[15rem] max-w-[2500px]  relative  ">
        ...
        onClick={() => router.push(`/`)}
      />
      <h3 className='text-blue-azure font-heading text-[1.1rem]'>Case Studies</h3>
        </div>
      

      <button onClick={()=>{
     
      }} className='text-white p-2 rounded-full bg-gray-700/80 '><svg  xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 30 30">
