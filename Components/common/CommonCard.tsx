    ...
    >
      ...
      >
        <div className="h-full w-full flex flex-col justify-between">
          ...
          {isSearchResult ? (
            <h2 className="font-semibold my-2 lg:my-4 text-[1rem] sm:text-[1.5rem] text-white">
              {title || ""}
            </h2>
          ) : (
            <h4 className="font-semibold my-2 lg:my-2 text-[1rem] sm:text-[1.5rem] text-white">
              {title || ""}
            </h4>
          )}
          {subdescription && (
          ...
          >
            ...
            {category && (
              <p
                className={classNames(
                  "text-blue-azure font-semibold text-start capitalize text-sm"
                )}
              >
                {reSlugify(category)}
              </p>
